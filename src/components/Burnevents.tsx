      ...
      {(!isLargeScreen && !isExpanded) ? (
        <button 
          ...
          className={`
            ...
            h-12
            rounded-[36px]            border border-pink-500
            px-5 py-3 
          ...
          `}
        >
          <span className="text-base sm:text-lg font-[900] font-['Product_Sans_Black']">Burn Events</span>
          <img 
            src={parkdownIcon} 
            alt="Expand" 
        ...
        >
          <div className={`flex items-center ${isLargeScreen ? 'justify-center' : 'justify-between'} mb-3 sm:mb-3 md:mb-4 lg:mb-3 xl:mb-3`}>
            <h3 className={`
              ...
              <span className="text-accent-pink">3 : </span>Burn Events
            </h3>
            {!isLargeScreen && (
              <img 
                src={parkdownIcon} 
            ...
            `}>
              {description || "Burn events permanently remove tokens from circulation, reducing the total supply and potentially increasing the value of remaining tokens over time."}
            </p>
          </div>
        </div>
      )}
