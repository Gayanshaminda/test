...
const PeekingPerson: React.FC<PeekingPersonProps> = ({
  ...
  const standardHeight =
    "h-[230px] sm:h-[240px] md:h-[260px] lg:h-[260px] xl:h-[270px] 2xl:h-[310px]";
  ...
  return (
    ...
    >
      ...
      <img
        src={imageSrc}
        alt={altText}
        className={`origin-right-center relative h-full w-full transform object-contain object-right transition-all duration-300`}
      />
    </div>
  );
};
