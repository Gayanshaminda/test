...
const Page2image: React.FC<Page2imageProps> = ({
  ...
  if (size === "putin-preset") {
    ...
    sizeClasses =
      "w-[670px] sm:w-[700px] md:w-[780px] lg:w-[850px] xl:w-[900px] 2xl:w-[1050px] h-[670px] sm:h-[700px] md:h-[780px] lg:h-[850px] xl:h-[900px] 2xl:h-[1050px]";
    finalPositionClasses =
      positionClasses ||
      "fixed bottom-0 left-[-110px] xs:left-[-80px] sm:left-1/2 sm:-translate-x-72 md:left-1/2 md:-translate-x-72 lg:left-1/2 lg:-translate-x-72 xl:left-1/2 xl:-translate-x-72 2xl:left-1/2 2xl:-translate-x-72 z-30";
    ...
    finalPositionClasses =
      positionClasses || `fixed ${bottom} ${left || "left-1/2 -translate-x-1/2"} z-30`;
  }
