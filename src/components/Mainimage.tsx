...
const Mainimage: React.FC<MainimageProps> = ({
  ...
  if (page >= 1 && page <= 3) {
    ...
    altText = "Putin";
    positionClasses =
      "fixed bottom-0 left-[-220px] xs:left-[-180px] sm:left-1/2 sm:-translate-x-1/2 md:left-1/2 md:-translate-x-1/2 lg:left-1/2 lg:-translate-x-1/2 xl:left-1/2 xl:-translate-x-1/2 2xl:left-1/2 2xl:-translate-x-1/2 z-10";
  } else if (page >= 4 && page <= 5) {
    sizePreset = "trump-size";
    imageSrc = trumpImage;
    altText = "Trump";
    positionClasses =
      "fixed bottom-0 left-[-110px] xs:left-[-80px] sm:left-1/2 sm:-translate-x-72 md:left-1/2 md:-translate-x-72 lg:left-1/2 lg:-translate-x-72 xl:left-1/2 xl:-translate-x-72 2xl:left-1/2 2xl:-translate-x-72 z-10";
  ...
  if (sizePreset === "putin-size") {
    ...
    sizeClasses =
      "w-[620px] sm:w-[650px] md:w-[720px] lg:w-[800px] xl:w-[800px] 2xl:w-[900px] h-[620px] sm:h-[650px] md:h-[720px] lg:h-[800px] xl:h-[800px] 2xl:h-[900px]";
  }
